...
happyExpList = Happy_Data_Array.listArray (0,27) ([640,7188,1280,14336,2560,32848,2946,0,1024,32,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parseExpr","Expr","ADD","SUB","MUL","LPAREN","RPAREN","num","%eof"]
        bit_start = st * 11
        bit_end = (st + 1) * 11
...
action_2 (5) = happyShift action_6
...
action_9 (5) = happyShift action_6
...
-- parse an expression (calls auto-generated functions)
parse :: String -> Expr
